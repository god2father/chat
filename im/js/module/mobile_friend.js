...
YX.fn.beginChat1 = function(){//从问题面板问题详情的立即沟通
    //面板切换
    $('#chatTitle1').addClass('active');
    $('#chatTitle2').removeClass('active');
    $('#chat-tab2').addClass('hide');
    $('#chat-tab1').removeClass('hide');
    var account = $.trim(this.$chat_zxwt_detail.find(".j-account").text().toLowerCase())
    this.hideAddFriend()
